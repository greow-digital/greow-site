...
const content = services.en['fractional']
const SITE_URL = 'https://greow.digital'
const EN = `${SITE_URL}${serviceUrl('fractional', 'en')}`
const SV = `${SITE_URL}${serviceUrl('fractional', 'sv')}`
...
export default function FractionalGrowthLeadEn() {
  const jsonLd = serviceJsonLd('en', 'fractional')
  return (
    <>
