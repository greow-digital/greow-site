...
const content = services.sv['advisory']
const SITE_URL = 'https://greow.digital'
const EN = `${SITE_URL}${serviceUrl('advisory', 'en')}`
const SV = `${SITE_URL}${serviceUrl('advisory', 'sv')}`
...
export default function GrowthAdvisorySv() {
  const jsonLd = serviceJsonLd('sv', 'advisory')
  return (
    <>
